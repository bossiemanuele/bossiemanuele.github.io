...
{% raw %}
<h2 style="font-size: 1.6em; font-weight: bold; margin-top: 30px;">Media Coverage</h2>

<!-- ✅ Carousel Wrapper -->
<div class="news-carousel-container" onmouseenter="pauseCarousel()" onmouseleave="resumeCarousel()">
  <!-- Carousel Track -->
  <div class="news-carousel-track" id="mediaCarouselTrack">
    <!-- Item 1 -->
    <div class="news-carousel-item">
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Make these functions global for the HTML buttons
