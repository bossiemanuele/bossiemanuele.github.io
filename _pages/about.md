...
I am a Ph.D. student in *Machine Learning* at the **Georgia Institute of Technology**. My research interests (check [here](https://bossiemanuele.github.io/files/ResearchStatement.pdf) for an updated research statement) center on reliable and trustworthy decision-making and learning in networked/multiagent settings. I am interested in developing both fundamental theories and practical algorithms that can be deployed in everyday life. The fundamental question I am trying to answer with my work is: *How can autonomous agents learn to make reliable decisions and cooperate effectively when the information and other agents they interact with may be uncertain, unreliable, or adversarial?*

I earned dual B.S. degrees, *Summa Cum Laude*, in Software Engineering and Data Science from **Embry-Riddle Aeronautical University**, along with a minor in Mathematics. During my undergraduate studies, I contributed to several [research projects](https://bossiemanuele.github.io/portfolio/undergraduate/) under the mentorship of various faculty members, working on topics spanning machine learning, network science, scientific computing, and autonomous systems. In Summer 2025, I joined the [*Jain Research Lab*](https://engineering.purdue.edu/JainResearchLab/) at **Purdue University** as a *Visiting Research Fellow*, conducting research on human cognition and automation in safety-critical systems.
